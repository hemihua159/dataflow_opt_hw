...
object Main {
  //s3参数
  val accessKey = "4C1D5EF21C436099F7AA"
  val secretKey = "WzlBQjA2Q0VGNTFBRTU0RDYzMEE5NDVBOUY1RDY0NEVCRENFNjczRUJd"
  val endpoint = "scuts3.depts.bingosoft.net:29999"
  val bucket = "wordcount"
   ...
   * 输入的主题名称
   */
  val inputTopic = "daas_himihua"
  //kafka参数
  val topic = "daas_himihua"
